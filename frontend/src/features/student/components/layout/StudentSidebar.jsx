...
import { studentNavigationLinks as navigation } from "../../../../config/student/studentConfig";
              ...
              <Link
                ...
                className={`flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 group ${
                  isActive 
                    ...
                    : "hover:bg-blue-50 dark:hover:bg-slate-800/50 text-slate-600 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400"
                }`}
              >
